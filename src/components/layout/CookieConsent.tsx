    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border p-4 md:p-6 animate-slide-in-right">
      <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-sm text-muted-foreground">
          🍪 Käytämme evästeitä, koska kaikki rakastavat keksejä! (Ja koska EU pakottaa kertomaan.)
          <a href="/tietosuoja" className="text-primary hover:underline ml-1">Lue lisää</a>
        </p>
