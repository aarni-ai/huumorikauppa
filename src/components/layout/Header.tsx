  ...
  return (
    <nav className="md:hidden border-t border-border bg-background pb-4">
      ...
      <Link
        to="/lahjat/joulu"
        onClick={onClose}
        className="block px-6 py-3 text-base font-bold text-sky-600 hover:text-sky-700 hover:bg-sky-50 transition-colors"
      >
        ☀️ Kesälahjat
      </Link>
      {mainCats.map(cat => (
    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background">
      ...
      <div className="container flex items-center justify-between h-14 md:h-16 gap-4">
        ...
        <nav className="hidden md:flex items-center gap-0.5">
          ...
          <Link
            to="/lahjat/joulu"
            className="px-3 py-2 text-sm font-bold text-sky-600 hover:text-sky-700 transition-colors rounded-md hover:bg-sky-50"
          >
            ☀️ Kesälahjat
          </Link>
