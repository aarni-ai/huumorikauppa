...
export function generateGiftGuideContent(s: SituationGift): GiftGuideContent {
  ...
  const shippingTrust =
    `Toimitamme kaikki tilaukset 3–7 arkipäivässä ympäri Suomen. Yli 60 € tilaukset toimitetaan ilmaiseksi. ` +
  ...
  const faqs: { q: string; a: string }[] = [
    ...
    },
    {
      ...
      a: `Toimitamme kaikki tilaukset 3–7 arkipäivässä Suomessa. Tilaukset yli 60 € lähetetään ilmaiseksi. Voit valita Postin pakettiautomaatin tai noutopisteen, joten paketti odottaa sinua sopivassa paikassa.`,
    },
    {
