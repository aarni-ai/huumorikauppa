...
export const CATEGORY_FAQS: Record<string, FAQ[]> = {
  "t-paidat": [
    ...
    { q: "Kuinka nopeasti tilaus toimitetaan?", a: "Tilaukset toimitetaan 3–10 arkipäivässä koko Suomeen PostNordin kautta. Ilmainen toimitus yli 60 € tilauksiin. Saat sähköpostiisi seurantakoodin heti kun paketti lähtee." },
  ...
  "hupparit": [
    ...
    { q: "Kuinka nopeasti huppari toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää koko Suomeen. Ilmainen toimitus yli 60 € tilauksiin." },
  ...
  "mukit": [
    ...
    { q: "Kuinka nopeasti muki toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Ilmainen toimitus yli 60 € tilauksiin." },
  ...
  "tarrat": [
    ...
    { q: "Kuinka nopeasti tarrat toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Ilmainen toimitus yli 60 € tilauksiin." },
  ...
  "pipot": [
    ...
    { q: "Kuinka nopeasti pipo toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Ilmainen toimitus yli 60 € tilauksiin." },
  ...
  "lippikset": [
    ...
    { q: "Kuinka nopeasti lippis toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Ilmainen toimitus yli 60 € tilauksiin." },
  ...
  "haalarimerkit": [
    ...
    { q: "Kuinka nopeasti haalarimerkit toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Ilmainen toimitus yli 60 € tilauksiin." },
...
export const GIFT_FAQS: Record<string, FAQ[]> = {
  ...
  "isanpaiva-lahjat": [
    ...
    { q: "Milloin viimeistään pitää tilata isänpäivälahja?", a: "Tilaa viimeistään 2 viikkoa ennen isänpäivää (marraskuun toinen sunnuntai). Toimitusaika on 3–10 arkipäivää." },
  ...
  "joululahjat": [
    ...
    { q: "Milloin viimeistään tilata joululahja?", a: "Tilaa viimeistään 14.12. saadaksesi tuotteen ennen joulua. Toimitusaika on 3–10 arkipäivää." },
  ...
  "syntymapaivalahjat": [
    ...
    { q: "Kuinka nopeasti syntymäpäivälahja toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Tilaa hyvissä ajoin jos synttäripäivä lähestyy." },
  ],
  "polttari-lahjat": [
  ...
  "elakelahjat": [
    ...
    { q: "Kuinka nopeasti eläkelahja toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Tilaa ajoissa ennen eläkejuhlia." },
  ],
  "lahja-kaverille": [
    ...
    { q: "Kuinka nopeasti lahja toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Tilaa hyvissä ajoin ennen synttäreitä." },
  ],
  "lahja-tyokaverille": [
    ...
    { q: "Kuinka nopeasti lahja toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Tilaa hyvissä ajoin ennen läksiäisiä." },
  ],
  "hauskat-t-paidat": [
  ...
  "opiskelijan-haalarimerkit": [
    ...
    { q: "Kuinka nopeasti haalarimerkit toimitetaan?", a: "Toimitusaika on 3–10 arkipäivää. Suuret ryhmätilaukset voivat kestää pidempään." },
